...
class CourseCommentsAdmin(object):
    list_display = ['user', 'course', 'commment','add_time']
    search_fields = ['user__nick_name', 'course__name', 'commment']
    list_filter = ['user__nick_name', 'course__name', 'commment','add_time']
